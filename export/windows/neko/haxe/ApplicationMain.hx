...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Rodrigo Peralta", "TP2", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TP2", null, { width: 768, height: 720 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 768, height: 720 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 768, 720, "null");
		#end
		#else
		create ();
		#end
