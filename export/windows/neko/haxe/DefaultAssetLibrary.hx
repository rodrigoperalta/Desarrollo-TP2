...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/cielo.jpg", AssetType.IMAGE);
		path.set ("assets/images/hummingbird.png", "assets/images/hummingbird.png");
		type.set ("assets/images/hummingbird.png", AssetType.IMAGE);
		...
		id = "assets/images/cielo.jpg";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/hummingbird.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
