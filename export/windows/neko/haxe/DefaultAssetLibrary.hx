...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/balaBoss.png", "assets/images/balaBoss.png");
		type.set ("assets/images/balaBoss.png", AssetType.IMAGE);
		...
		type.set ("assets/images/BossLife.png", AssetType.IMAGE);
		...
		type.set ("assets/images/gradius.png", AssetType.IMAGE);
		path.set ("assets/images/gradius1.png", "assets/images/gradius1.png");
		type.set ("assets/images/gradius1.png", AssetType.IMAGE);
		path.set ("assets/images/NaveFinal.png", "assets/images/NaveFinal.png");
		type.set ("assets/images/NaveFinal.png", AssetType.IMAGE);
		...
		type.set ("assets/images/PowerUpsCol.png", AssetType.IMAGE);
		...
		type.set ("assets/sounds/muerteEnemigos.ogg", AssetType.SOUND);
		path.set ("assets/sounds/muertePj.ogg", "assets/sounds/muertePj.ogg");
		type.set ("assets/sounds/muertePj.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/beep.ogg", __ASSET__flixel_sounds_beep_ogg);
		type.set ("flixel/sounds/beep.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/flixel.ogg", __ASSET__flixel_sounds_flixel_ogg);
		type.set ("flixel/sounds/flixel.ogg", AssetType.SOUND);
		...
		id = "assets/images/balaBoss.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Boss.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/BossLife.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/gradius.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/gradius1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/NaveFinal.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/PowerUpsCol.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/muerteEnemigos.ogg";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/muertePj.ogg";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
